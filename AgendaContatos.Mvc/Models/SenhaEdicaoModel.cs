...
namespace AgendaContatos.Mvc.Models
{
    ...
    public class SenhaEdicaoModel
    {
        ...
        [SenhaValidation(ErrorMessage = "Informe uma senha com pelo menos 1 letra maiúscula, 1 letra minúscula, 1 dígito numérico e 1 caractere especial(@,#,$,%,&).")][MinLength(8, ErrorMessage = "Por favor, informe no mínimo {1} caracteres.")]
