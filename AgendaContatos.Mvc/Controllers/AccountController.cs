        ...
        public IActionResult Login(AccountLoginModel model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        SignIn(usuario); //auteticando o usuário
                                         //no AspNet MVC
        ...
        public IActionResult Register(AccountRegisterModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    {
                        TempData["Mensagem"] = "O email informadojá foi cadastrado, tente outro.";
...
ModelState.Clear();
                ...
                {
                    TempData["Mensagem"] = $"Falha ao cadastrarusuário: { e.Message} ";
